...
_reactDom2.default.render(_react2.default.createElement(_header2.default, null), document.getElementById('demo'));
...
var Component_header = function (_React$Component) {
	_inherits(Component_header, _React$Component);

	function Component_header() {
		_classCallCheck(this, Component_header);

		return _possibleConstructorReturn(this, (Component_header.__proto__ || Object.getPrototypeOf(Component_header)).apply(this, arguments));
	}
